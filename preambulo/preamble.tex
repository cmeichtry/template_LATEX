...
\usepackage{subfiles} %permite la utilización de subfiles
...
\usepackage{subcaption} % manejo de subfigure
...
%\usepackage{subfigure} %Permite poner subfiguras OBSOLETO
...
\usepackage{xurl} %urls con linebreaks
...
\usepackage{tikz} %permite realizar gráficos
...
%QUITAR EL WARNING POR USAR MATH EN TITULOS Y SUBTITULOS
\makeatletter
